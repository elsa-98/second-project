...
<section>
	<div class="container">
		<h2 class="mb-5">ASSESSMENT</h2>
			<div style="overflow-x:auto;">
			<table class="table table-striped">
                <th class="frm">student_name </th>
                <th class="frm">assess_no</th>
                <th class="frm">max_mark</th>
                <th class="frm">subject_1</th>
                <th class="frm">subject_2</th>
                <th class="frm">subject_3</th>
                <th class="frm">subject_4</th>
                <th class="frm">subject_5</th>
                {%if authors%}
                {%for i in authors%}
                
				
                    <tr><td  class="frm">{{i.student_name}}</td>
                    <td class="frm">{{i.assess_no}}</td>
                    <td class="frm">{{i.max_mark}}</td>
                    <td class="frm">{{i.subject_1}}</td>
                    <td class="frm">{{i.subject_2}}</td> 
                    <td class="frm">{{i.subject_3}}</td>
                    <td class="frm">{{i.subject_4}}</td>
                    <td class="frm">{{i.subject_5}}</td>  
                  </tr>
